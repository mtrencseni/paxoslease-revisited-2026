...
The standard use of the lease, and the one Keyspace and ScalienDB implement, is the classic Multi-Paxos leader optimization.  We state the leader lifecycle precisely, in the discipline of Section~\ref{sec:algorithm}: each step names its counterpart in the composition model (\code{tla/spec/PaxosLeasePaxos.tla}) and in the executable Python model, and those artifacts govern.
